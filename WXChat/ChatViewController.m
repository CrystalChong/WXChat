...
- (void)addChatView
{
    ...
    UITableView *chatView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth , kScreenHeight - 64 - kToolBarH) style:UITableViewStylePlain];
...
- (void)addToolBar
{
    ...
    bgView.frame = CGRectMake(0, kScreenHeight - (44 + kStatusBarHeight) - kToolBarH, kScreenWidth, kToolBarH);
...
- (void)keyboardWillChange:(NSNotification *)note
{
    ...
    CGFloat moveY = kScreenHeight - (44 + kStatusBarHeight) - keyFrame.size.height;
...
{
    _toolBar.bottom = kScreenHeight - (44 + kStatusBarHeight);
    _chatView.bottom = kScreenHeight - (44 + kStatusBarHeight) -_toolBar.height;
    // 添加内填充让表示图的内容可以现实到下面
